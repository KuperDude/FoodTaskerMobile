...
#Preview {
    ForgotPasswordSegment(vm: ForgotPasswordViewModel())
}
...
extension ForgotPasswordSegment {
    ...
    var bottomCircleSegment: some View {
        HStack {
            Group {
                Circle()
                    .foregroundStyle(vm.state.rawValue > 1 ? Color.theme.green : .secondary)
                Circle()
                    .foregroundStyle(vm.state.rawValue > 2 ? Color.theme.green : .secondary)
                Circle()
                    .foregroundStyle(vm.state.rawValue > 3 ? Color.theme.green : .secondary)
            }
